...
public class RegistrationController {
    ...
    public String addUser(@RequestParam("passwordConfirm") String passwordConfirm, @Valid User user,
                          BindingResult bindingResult, Model model) {
        boolean isConfirmEmpty = StringUtils.isEmpty(passwordConfirm);
        if (isConfirmEmpty) {
            model.addAttribute("messageConfirmError", "Passwords are different");
        }
